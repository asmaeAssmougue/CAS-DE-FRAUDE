<?php
 ...
 session_start();
 if(!isset($_SESSION['session']) || !isset($_SESSION['anneeUnv']) || !isset($_SESSION['date'])){
?>
  ...
  <body>
    <div class="container">
          <div id="logo">
           ...
           <section>
      <p class="p">
            نتائج اجتماع المجلس التاديبي المنعقد بتاريخ <?php echo $dateC; ?> حول حالات الغش <br>
